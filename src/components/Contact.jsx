          ...
          <div className="col-lg-5">
            <div className="contact-info-card h-100 p-4">
              ...
              <div className="d-flex gap-3">
                <a href="https://github.com/student-Ashishjha" target="_blank" rel="noopener noreferrer" className="social-link">
                ...
                <a href="http://www.linkedin.com/in/ashish-jha-b2751a31a" target="_blank" rel="noopener noreferrer" className="social-link">
                ...
                <a href="https://leetcode.com/u/Ashish_jha1/" target="_blank" rel="noopener noreferrer" className="social-link">
